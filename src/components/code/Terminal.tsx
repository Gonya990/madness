...
const OUT_CLASS: Record<string, string> = { output: 'uc-term__out', success: 'uc-term__ok', error: 'uc-term__err', warning: 'uc-term__warn', comment: 'uc-term__comment' };
...
export function Terminal({ lines = [], title = 'bash — unicode', prompt = '$', showCursor = true, promptLabel, className = '', style = {}, ...rest }: TerminalProps) {
