...
import { highlightToLines, codeColors } from './highlight.js';
...
export function CodeBlock({
  code, children, language = 'js', filename, showLineNumbers = false,
  copy = true, highlightLines = [], dark = false, maxHeight,
  ...
  const doCopy = () => {
    try { navigator.clipboard.writeText(src); } catch (e) { /* noop */ }
    setCopied(true);
